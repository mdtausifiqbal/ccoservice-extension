...
export function copyServiceText({ brand, data }: ServiceInfoData): void {
  ...
  } else if (brand === "DaikinV2") {
    callNo = data.ticketId;
    registeredPhoneNo = data.customerMobile;
    alternatePhoneNo = ""; // Assuming no alternate phone in DaikinV2
    customerName = data.customerName;
    address = data.customerAddress;
    company = "Daikin";
    product = "AC";
    callType = data.caseType;
